...
#define BTPS_CONFIGURATION_HCI_MAXIMUM_SUPPORTED_HCI_PACKET_SIZE           (HCI_CALCULATE_ACL_DATA_SIZE(1024))
...
#define BTPS_CONFIGURATION_HCI_NUMBER_OF_SCO_DATA_PACKETS                  0
   ...
   /* L2CAP Configuration.                                              */
#define BTPS_CONFIGURATION_L2CAP_MAXIMUM_SUPPORTED_STACK_MTU               (1024 - L2CAP_DATA_PACKET_HEADER_SIZE)
...
#define BTPS_CONFIGURATION_HFRE_SUPPORT_LONG_SPRINTF_MODIFIER                 0
...
#define BTPS_CONFIGURATION_ISPP_SUPPORT_QUEUE_SESSION_PACKET_POINTER          1
